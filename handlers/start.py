...
@Client.on_message(filters.command(["start", "start@ich_music_bot"]) & filters.private & ~filters.channel)
async def start(_, message: Message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            ...
            InlineKeyboardButton("💬 Group", url="https://t.me/linkchatting"),
...
async def gstart(_, message: Message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
            InlineKeyboardButton(text="🎙️ Support Group 🎙️", url="https://t.me/JasmineSupportGroup")
            ]]
        )
    )


@Client.on_message(filters.command(["cmdlist", "start@ich_music_bot"]) & filters.private & ~filters.channel)
